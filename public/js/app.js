...
/***/ "./resources/js/project/google-map.js":
/*!********************************************!*\
  !*** ./resources/js/project/google-map.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
loader.load().then(function () {
  ...
  google.maps.event.addListener(map, "click", function (event) {
    ...
    GetAddress(clickLat.toFixed(7), clickLon.toFixed(7)); // marker = new google.maps.Marker({
...
function _getInfo() {
  _getInfo = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee(city) {
    var contentString;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 4;
            return axios.get("/get-city-info/".concat(city)).then(function (res) {
              var response = res.data.data;
              console.log(' ress', res.data);

              if (res.data.status == true) {
                contentString = "<div id=\"content\"><div id=\"siteNotice\"></div>\n                                <h1 id=\"firstHeading\" class=\"firstHeading\">".concat(city, "</h1>\n                                <div id=\"bodyContent\"><ul>\n                                <li>Message Id : ").concat(response.messageid, "</li>\n                                <li>Message : ").concat(response.message, "</li>\n                                <li>Sentiment : ").concat(response.sentiment, "</li>\n                                </ul></div></div>");
              } else {
                contentString = '';
              }
          ...
          case 5:
            marker.addListener("click", function () {
              if (contentString.length > 0) infowindow.open(map, marker);else infowindow.close();
            });
